...
import 'package:study_box/feature/video_details/presentation/view/widget/video_details_view_body.dart';

class VideoDetailsView extends StatelessWidget {
  const VideoDetailsView({super.key, required this.subjectId});
      ...
      child: Scaffold(
        body: SafeArea(
          child: Padding(
            ...
            child: VideoDetailsViewBody(subjectId: subjectId),
          ),
        ),
      ),
    );
